...
app.post("/submitReviewerName", function (req, res) {
  ...
  const usernameStartIndex = rawData.indexOf("username: '") + 11; // Adding 11 to skip the length of "username: '"
  const usernameEndIndex = rawData.indexOf("'", usernameStartIndex);
  const username = rawData.substring(usernameStartIndex, usernameEndIndex);

  // Extracting password
  const passwordStartIndex = rawData.indexOf("password: '") + 11; // Adding 11 to skip the length of "password: '"
  const passwordEndIndex = rawData.indexOf("'", passwordStartIndex);
  const password = rawData.substring(passwordStartIndex, passwordEndIndex);
